...
The checked-in catalog contains 447 real, publicly documented Virginia ecosystem assets reviewed on August 5, 2026. It is generated by `scripts/build_real_asset_catalog.py` and stored in `data/virginia_real_assets.json` so changes can be reviewed before they reach the database.
